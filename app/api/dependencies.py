...
from fastapi import BackgroundTasks, Depends, HTTPException, status  # type: ignore
...
def get_shipment_service(session: SessionDep, tasks: BackgroundTasks):  # type: ignore
